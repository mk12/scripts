...
show "8" "error/-"      1 0 0 ; gap; show "9" "directive"    9 0 0; echo
show "b" "keyword/+"    2 0 0 ; gap; show "1" "highlight"   10 0 7; echo
show "a" "identifier"   3 0 0 ; gap; show "2" "selection"   11 0 7; echo
show "d" "function"     4 0 0 ; gap; show "4" "subtle"      12 0 0; echo
show "e" "type/other"   5 0 0 ; gap; show "6" "emphasis"    13 0 0; echo
show "c" "constant"     6 0 0 ; gap; show "f" "special"     14 0 0; echo
